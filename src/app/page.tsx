...
export default function Home() {
  ...
  const getExchangeRate = async () =>{
    const API_URL = `https://v6.exchangerate-api.com/v6/${process.env.API_KEY}/pair/${fromCurrency}/${toCurrency}`;
    try{
  ...
  return (
    <main className="">
      ...
      <div className="flex items-center justify-center flex-col space-y-3 bg-[#0e1e52] rounded-2xl p-6 px-28 opacity-90 shadow-2xl">
        ...
        <div className="scale-125 bg-[#5250d1] rounded-full p-3 hover:opacity-85 hover:scale-150 " onClick={handleSwapCurrencies}>
